...
// Client shell for the incidents management page. The parent server
// component (page.tsx) fetches the initial rows so first paint has data
// — no "Loading…" flash, no client-side round-trip on entry. This shell
// only re-fetches after user actions that would change the list.
export default function IncidentsShell({
  initialRows,
}: {
  initialRows: ManagerIncidentSummary[];
}) {
