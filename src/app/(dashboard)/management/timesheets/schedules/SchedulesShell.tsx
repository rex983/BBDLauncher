...
// Parent page.tsx server component hydrates the roster + schedule
// overrides so first paint is populated. Client refetches when
// viewAsOffice flips or after Save.
